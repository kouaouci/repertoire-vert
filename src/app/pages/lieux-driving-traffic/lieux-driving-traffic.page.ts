...
@Component({
  selector: 'app-lieux-driving-traffic',
  templateUrl: './lieux-driving-traffic.page.html',
  styleUrls: ['./lieux-driving-traffic.page.scss'],
})
export class LieuxDrivingTrafficPage {
  ...
  loadMap() {
    this.map = new L.Map("maptraffic").setView([46.2044, 6.1432], 12);
