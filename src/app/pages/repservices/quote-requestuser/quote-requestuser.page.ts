...
@Component({
  selector: 'app-quote-requestuser',
  templateUrl: './quote-requestuser.page.html',
  styleUrls: ['./quote-requestuser.page.scss'],
})
export class QuoteRequestuserPage implements OnInit {
  quotes:any;
  comments:any;
  likes:any;
  CompanyId:any;
  ...
  userInformations:any = []; 
    ...
    ngOnInit() {
      this.authProvider.profile().subscribe(data =>{
        ...
        this.repVertAPI.getQuoteDemandByUser(this.userInformations.id).subscribe(data =>{  
          this.quotes =data
