...
@Component({
  selector: 'app-lieux-driving',
  templateUrl: './lieux-driving.page.html',
  styleUrls: ['./lieux-driving.page.scss'],
})
export class LieuxDrivingPage  {
  ...
  loadMap() {
    this.map = new L.Map("mappricing").setView([46.2044, 6.1432], 12);
